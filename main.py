...
from src.visuals import visualize_nets
    ...
    while population.gen <= max_generations:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                sys.exit()
        components.window.fill((10,10,10))
        components.ground.draw_ground(components.window)
        ...
        for pipe in components.pipes:
            pipe.update()
            pipe.draw_pipe(components.window)
            if pipe.offscreen:
        ...
        components.window.blit(gen_text, (10, components.window.get_height() - 90))
        components.window.blit(best_text, (10, components.window.get_height() - 60))
        components.window.blit(lead_species_text, (10, components.window.get_height() - 30))
